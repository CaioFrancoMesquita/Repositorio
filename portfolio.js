const translations = {
    'pt-BR': {
        ...
        'about.age': 'Idade: 20 anos',
        'about.experience': 'Estou a procura da primeira oportunidade de emprego',
        'about.internship': 'Procuro estágios nos horários da tarde e/ou noite',
        ...
        'projects.project2.title': 'Projeto Sisbiblioteca',
        'projects.project2.desc': 'API REST para gerenciamento de autores e livros, desenvolvida em Java com Spring e persistência JPA',
        'projects.project3.title': 'Projeto PokeAPI',
        'projects.project3.desc': 'Site de pesquisa de Pokémon desenvolvido como avaliação de Programação de Scripts I, utilizando HTML e JavaScript',
        ...
        'courses.course1.current': 'Atualmente no quarto semestre.',
    ...
    'en': {
        ...
        'projects.project2.title': 'Sisbiblioteca Project',
        'projects.project2.desc': 'REST API for managing authors and books, developed in Java with Spring and JPA persistence',
        'projects.project3.title': 'PokeAPI Project',
        'projects.project3.desc': 'Pokémon search website developed as an assessment for Programming Scripts I, using HTML and JavaScript',
        ...
        'courses.course1.current': 'Currently in the fourth semester.',
    ...
    'es': {
        ...
        'projects.project2.title': 'Proyecto Sisbiblioteca',
        'projects.project2.desc': 'API REST para gestionar autores y libros, desarrollada en Java con Spring y persistencia JPA',
        'projects.project3.title': 'Proyecto PokeAPI',
        'projects.project3.desc': 'Sitio de búsqueda de Pokémon desarrollado como evaluación de Programación de Scripts I, utilizando HTML y JavaScript',
        ...
        'courses.course1.current': 'Actualmente en el cuarto semestre.',
    ...
    'fr': {
        ...
        'projects.project2.title': 'Projet Sisbiblioteca',
        'projects.project2.desc': 'API REST de gestion des auteurs et des livres, développée en Java avec Spring et une persistance JPA',
        'projects.project3.title': 'Projet PokeAPI',
        'projects.project3.desc': 'Site de recherche de Pokémon développé comme évaluation de Programmation de Scripts I, utilisant HTML et JavaScript',
        ...
        'courses.course1.current': 'Actuellement au quatrième semestre.',
